...
class CMSSeeder extends Seeder
{
    ...
    public function run()
    {
        FAQ::create([
            ...
            'answer' => 'Quantum is a starter app using Quarx. It makes it easy as possible to jumpstart an app/ website by allowing you to get started with as little as a single command to create the project.',
            'is_published' => true,
