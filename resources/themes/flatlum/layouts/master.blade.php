        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="http://demo.startlaravel.com/sb-admin-laravel/#"><i class="fa fa-user fa-fw"></i> User
                            Profile</a>
                    </li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav in" id="side-menu">
                    ...
                    <li>
                        <a href="http://demo.startlaravel.com/sb-admin-laravel/tables"><i class="fa fa-table fa-fw"></i>
                            Tables</a>
                    </li>
                    <li>
                        <a href="http://demo.startlaravel.com/sb-admin-laravel/forms"><i class="fa fa-edit fa-fw"></i>
                            Forms</a>
                    </li>
                    <li>
                        <a href="http://demo.startlaravel.com/sb-admin-laravel/#"><i class="fa fa-wrench fa-fw"></i> UI
                    ...
                    <li>
                        <a href="http://demo.startlaravel.com/sb-admin-laravel/#"><i class="fa fa-sitemap fa-fw"></i>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level collapse">
                                    <li>
                                        <a href="http://demo.startlaravel.com/sb-admin-laravel/#">Third Level Item</a>
                                    </li>
                                    <li>
                                        <a href="http://demo.startlaravel.com/sb-admin-laravel/#">Third Level Item</a>
                                    </li>
                    ...
                    <li>
                        <a href="http://demo.startlaravel.com/sb-admin-laravel/#"><i class="fa fa-files-o fa-fw"></i>
                ...
                <div class="row">
                                        ...
                                        <div class="timeline-panel">
                                            ...
                                            <div class="timeline-body">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem
                                                    ...
                                                    libero, quis rerum. Fugiat esse debitis optio, tempore. Animi
                                            ...
                                            <div class="timeline-body">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="http://demo.startlaravel.com/sb-admin-laravel/#">Action</a>
                                                        </li>
                                                        <li><a href="http://demo.startlaravel.com/sb-admin-laravel/#">Another
                                                                action</a>
                                                        </li>
                                                        <li><a href="http://demo.startlaravel.com/sb-admin-laravel/#">Something
                                                                else here</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li><a href="http://demo.startlaravel.com/sb-admin-laravel/#">Separated
                                                                link</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="timeline-panel">
                                            ...
                                            <div class="timeline-body">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi fuga
                                                    odio quibusdam. Iure expedita, incidunt unde quis nam! Quod,
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <canvas id="cline" width="509" height="319"
                                        style="width: 509px; height: 319px;"></canvas>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="list-group">
                                    <a href="http://demo.startlaravel.com/sb-admin-laravel/#" class="list-group-item">
                                        <i class="fa fa-comment fa-fw"></i> New Comment
                            ...
                            <div class="panel-body">
                                <ul class="chat">
                                    ...
                                    <span class="chat-img pull-left">
                                        <img src="./frontpage_files/fff" alt="User Avatar" class="img-circle">
                                    </span>
                                    ...
                                    <span class="chat-img pull-right">
                                        <img src="./frontpage_files/fff(1)" alt="User Avatar" class="img-circle">
                                    </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
